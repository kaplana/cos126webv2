...
- You must never receive or view any solutions to a programming assignment (or variant of an assignment) other than your own.  This includes other students' solutions, solutions available on the Internet, code generated by tools (e.g., ChatGPT, GitHub Copilot), etc.
